...
def get_cifar100_loaders(num_clients, batch_size):
...
if __name__ == "__main__":
    ...
    clients, test = get_cifar100_loaders(num_clients=10, batch_size=128)
    ...
    # 3. DGL 1:5
    reset_env()
    clients, test = get_cifar100_loaders(num_clients=5, batch_size=128)
    ...
    clients, test = get_cifar100_loaders(num_clients=1, batch_size=128)
